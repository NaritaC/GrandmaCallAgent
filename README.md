...
Android CI 使用 JDK 17、Android SDK 35 和 Gradle 8.9 执行 `:app:testDebugUnitTest :app:assembleDebug`。基线提交 `81c31e3` 已在 [Android V0 workflow](https://github.com/NaritaC/GrandmaCallAgent/actions/workflows/android-v0.yml) 中通过，并生成单元测试报告和未签名 debug APK；这只证明代码可构建，不代替微信真机验证。
